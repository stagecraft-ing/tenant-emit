#!/usr/bin/env bash
# Git merge driver `tenant-emit-derived-regen` for the committed derived
...
#   .derived/**/*.json   merge=tenant-emit-derived-regen
#
...
#
# Mirror of spec-spine's `.githooks/merge-derived-index.sh`. tenant-emit dogfoods
